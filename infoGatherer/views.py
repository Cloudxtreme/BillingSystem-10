...
def print_form(request, bar, claim_id):
    ...
    for i in range(1,7):
        ...
        # Diagnostic pointer
        diag=(bar['dx_pt_s1_'+str(i)] if bar['dx_pt_s1_'+str(i)]!='---' else '')+\
                    (bar['dx_pt_s2_'+str(i)] if bar['dx_pt_s2_'+str(i)]!='---' else '')+\
                    (bar['dx_pt_s3_'+str(i)] if bar['dx_pt_s3_'+str(i)]!='---' else '')+\
                    (bar['dx_pt_s4_'+str(i)] if bar['dx_pt_s4_'+str(i)]!='---' else '')
