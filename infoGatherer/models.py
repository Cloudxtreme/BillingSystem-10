...
POS = (
    ("Ambulance - Air or Water (42)","Ambulance - Air or Water (42)"),
    ("Ambulance - Land (41)","Ambulance - Land (41)"),
    ("Ambulatory Surgical Center (24)","Ambulatory Surgical Center (24)"),
    ("Assisted Living Facility (13)","Assisted Living Facility (13)"),
    ("Birthing Center (25)","Birthing Center (25)"),
    ("Community Mental Health Center (53)","Community Mental Health Center (53)"),
    ("Comprehensive Inpatient Rehabilitation Facility (61)","Comprehensive Inpatient Rehabilitation Facility (61)"),
    ("Comprehensive Outpatient Rehabilitation Facility (62)","Comprehensive Outpatient Rehabilitation Facility (62)"),
    ("Custodial Care Facility (33)","Custodial Care Facility (33)"),
    ("Emergency Room - Hospital (23)","Emergency Room - Hospital (23)"),
    ("End-Stage Renal Disease Treatment Facility (65)","End-Stage Renal Disease Treatment Facility (65)"),
    ("Federally Qualified Health Center (50)","Federally Qualified Health Center (50)"),
    ("Group Home (14)","Group Home (14)"),
    ("Home (12)","Home (12)"),
    ("Homeless Shelter (04)","Homeless Shelter (04)"),
    ("Hospice (34)","Hospice (34)"),
    ("Independent Clinic (49)","Independent Clinic (49)"),
    ("Independent Laboratory (81)","Independent Laboratory (81)"),
    ("Indian Health Service Free-standing Facility (05)","Indian Health Service Free-standing Facility (05)"),
    ("Indian Health Service Provider-based Facility (06)","Indian Health Service Provider-based Facility (06)"),
    ("Inpatient Hospital (21)","Inpatient Hospital (21)"),
    ("Inpatient Psychiatric Facility (51)","Inpatient Psychiatric Facility (51)"),
    ("Intermediate Care Facility/Mentally Retarded (54)","Intermediate Care Facility/Mentally Retarded (54)"),
    ("Mass Immunization Center (60)","Mass Immunization Center (60)"),
    ("Military Treatment Facility (26)","Military Treatment Facility (26)"),
    ("Mobile Unit (15)","Mobile Unit (15)"),
    ("Non-residential Substance Abuse Treatment Facility (57)","Non-residential Substance Abuse Treatment Facility (57)"),
    ("Nursing Facility (32)","Nursing Facility (32)"),
    ("Off Campus - Outpatient Hospital (19)","Off Campus - Outpatient Hospital (19)"),
    ("Office (11)","Office (11)"),
    ("On Campus - Outpatient Hospital (22)","On Campus - Outpatient Hospital (22)"),
    ("Other Place of Service (99)","Other Place of Service (99)"),
    ("Pharmacy (01)","Pharmacy (01)"),
    ("Prison-Correctional Facility (09)","Prison-Correctional Facility (09)"),
    ("Psychiatric Facility-Partial Hospitalization (52)","Psychiatric Facility-Partial Hospitalization (52)"),
    ("Psychiatric Residential Treatment Center (56)","Psychiatric Residential Treatment Center (56)"),
    ("Public Health Clinic (71)","Public Health Clinic (71)"),
    ("Residential Substance Abuse Treatment Facility (55)","Residential Substance Abuse Treatment Facility (55)"),
    ("Rural Health Clinic (72)","Rural Health Clinic (72)"),
    ("School (03)","School (03)"),
    ("Skilled Nursing Facility (31)","Skilled Nursing Facility (31)"),
    ("Temporary Lodging (16)","Temporary Lodging (16)"),
    ("Tribal 638 Free-standing Facility (07)","Tribal 638 Free-standing Facility (07)"),
    ("Tribal 638 Provider-based Facility (08)","Tribal 638 Provider-based Facility (08)"),
    ("Urgent Care Facility (20)","Urgent Care Facility (20)"),
    ("Walk-in Retail Health Clinic (17)","Walk-in Retail Health Clinic (17)"),
)
