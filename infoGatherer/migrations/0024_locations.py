...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('infoGatherer', '0023_auto_20151230_1427'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_name', models.CharField(default=b'', max_length=128)),
                ...
                ('phone', localflavor.us.models.PhoneNumberField(help_text=b'XXX-XXX-XXXX', max_length=20, null=True, blank=True)),
            ],
        ),
    ]
