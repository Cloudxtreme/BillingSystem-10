...
class ExtBaseSerializer(BaseSerializer):
    ...
    def serialize(self, queryset, **options):
        ...
        self.first = True
        if type(queryset) == models.query.QuerySet:
            for obj in queryset:
            ...
            # Else case will be executed if object is a single instance.
            # However, the serialized string will be in array just like
            # as it is a query set anyway.
            obj = queryset
            self.start_object(obj)
            concrete_model = obj._meta.concrete_model
            for field in concrete_model._meta.local_fields:
